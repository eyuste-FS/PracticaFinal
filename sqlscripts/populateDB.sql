...
insert into PRACTICA.EM_EMPLEADOS values
	...
	(NULL, "nif2", "nombre2", "apellido12", "apellido22", "2000-01-02", "tele12", "tele22", "email2", "2020-10-22", NULL, 'C', 'S'),
	(NULL, "nif3", "nombre3", "apellido13", "apellido23", "2000-01-03", "tele13", "tele23", "email3", "2020-10-23", NULL, 'S', 'S');
