...
insert into PRACTICA.EM_EMPLEADOS (
		TX_NIF, TX_NOMBRE, TX_APELLIDO1, TX_APELLIDO2,
		F_NACIMIENTO, N_TELEFONO1, N_TELEFONO2, TX_EMAIL, F_ALTA, F_BAJA,
		CX_EDOCIVIL, B_SERVMILITAR) values
...
insert into PRACTICA.PR_PROYECTOS
	(TX_DESCRIPCIÓN, F_INICIO, F_FIN, F_BAJA, TX_LUGAR, TX_OBSERVACIONES) values
...
insert into PRACTICA.PR_EMPLEADOS_PROYECTO
	(ID_PROYECTO, ID_EMPLEADO, F_ALTA) values
	(1, 1, "2022-10-01"),
    (2, 1, "2022-10-02"),
    (2, 2, "2022-10-04"),
    (3, 2, "2022-10-04"),
